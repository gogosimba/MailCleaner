    ...
    try:
        ...
        post_data = {
            ...
            "meta_input": {
                ...
                "awsm_job_category": "Sigma",  # Jobbkategori om vi någonsin cleanar det
                "awsm_job_type": "Heltid",  # Heltid/deltid om det går att cleana
                "awsm_job_location": "Över hela sverige",  # Plats om det går att cleana. Ifall detta läggs in kan man filtrera jobb
            },
        }        
        headers = {
